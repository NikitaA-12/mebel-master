    ...
    <section className="room">
      <div className="container">
        <div className="room__top">
          <h2 className="cart__title">Бонусная программа</h2>
        ...
        <div className="room__row">
          <form className="room__form">
            <h2 className="cart__title">Личные данные</h2>
            ...
            <button className="room__form-btn">Изменить</button>
          </form>
          <table className="room__table">
            <h2 className="cart__title">Мои заказы</h2>
