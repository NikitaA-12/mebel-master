          ...
          <div className="checkout__form-row">
            <div className="checkout__form-block">
              ...
              <div className="checkout__form-fields">
                <input
                  ...
                  placeholder="Имя"
                  type="text"
                  className="checkout__form-fields__input"
                />
                <input
                  {...register('email')}
                  value={user.email}
            ...
            <div className="checkout__form-block">
              ...
              <ul className="checkout__form-list">
                ...
                {user.carts?.map((item) => (
                  <li key={item.id} className="checkout__form-item checkout__form-product">
                    {' '}
                    {item.title}{' '}
                    <span>
                ...
                <li className="checkout__form-item checkout__form-item_count">
                  <p className="checkout__form-product">Количество бонусов:</p>
                  <p className="checkout__form-price">{user.point}Б</p>
                </li>

                <li className="checkout__form-item checkout__form-total">
                  Итого
                  <span>{user.carts?.reduce((acc, rec) => acc + rec.price * rec.count, 0)} ₽</span>
                </li>
                <li className="checkout__form-block">
      ...
      {popup ? (
        <div className="checkout__popup">
          ...
          <p className="checkout__popup-text">
            Через {count} секунд вас перекинет на главную страницу
          </p>
          <button onClick={() => navigate('/')} className="checkout__popup-btn">
